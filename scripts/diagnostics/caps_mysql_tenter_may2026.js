/**
 * tenter 테이블에서 E_GROUP = '08'인 2026년 5월 출입기록 조회
 * - 읽기 전용
 * - 서버PC에서 실행
 *
 * 실행:
 *   node caps_mysql_tenter_may2026.js
 */
...
const START_DATE = '20260501';
const END_DATE = '20260531';
...
async function main() {
  ...
  try {
    console.log('==================================================');
    console.log(" tenter.E_GROUP = '08' / 2026-05 조회");
    console.log('==================================================');
