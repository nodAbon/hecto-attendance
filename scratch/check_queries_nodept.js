...
async function checkBhkimQueries() {
  const userId = '704f71b2-14d5-4e9b-b7f8-17e72a5e4fed';
  
  // Try resolving profile manually WITHOUT dept column (since raw dump has "dept: undefined" meaning the column might not exist or be named differently, wait, in raw dump we saw dept: undefined, wait! Let's check error info)
  ...
  console.log('Resolved Profile (No dept col):', profile);
